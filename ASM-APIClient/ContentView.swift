...
struct ContentView: View {
    @StateObject private var viewModel = ASMViewModel()
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        VStack(alignment: .leading, spacing: 4) {
                            Label("Client ID", systemImage: "person.circle")
                                .font(.caption)
                                .foregroundColor(.secondary)
                            TextField("SCHOOLAPI.xxx", text: $viewModel.clientId)
...
struct DevicesView: View {
    @ObservedObject var viewModel: ASMViewModel
        ...
        VStack(spacing: 0) {
            ...
            if viewModel.devices.isEmpty {
                ...
                ContentUnavailableView(
                    ...
                    description: Text("Click 'Connect to ASM' in the sidebar to load devices")
                )
                Spacer()
        ...
        VStack(spacing: 0) {
            ...
            if viewModel.mdmServers.isEmpty {
                ContentUnavailableView(
                    ...
                    description: Text("Click 'Connect to ASM' in the sidebar to load servers")
                )
            } else {
